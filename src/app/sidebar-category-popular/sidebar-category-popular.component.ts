...
@Component({
  selector: 'app-sidebar-category-popular',
  templateUrl: './sidebar-category-popular.component.html',
  styleUrls: ['./sidebar-category-popular.component.css']
})
export class SidebarCategoryPopularComponent implements OnInit {
